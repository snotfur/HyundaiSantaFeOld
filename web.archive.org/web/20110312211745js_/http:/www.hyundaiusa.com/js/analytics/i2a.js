...
function pixel()
{
	...
	if (!ic_cat) { ic_cat=""; }
	if (!ic_type) { ic_type=""; }
	if (locHttp.toLowerCase( ) == "https")  { prefix="https://web.archive.org/web/20110307002043/https://www"+icstring+"";}
	if (locHttp.toLowerCase( ) == "http")  { prefix="https://web.archive.org/web/20110307002043/http://1534"+icstring+"";}
...
/*
     FILE ARCHIVED ON 00:20:43 Mar 07, 2011 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 03:03:36 Oct 09, 2024.
...
playback timings (ms):
  ...
  esindex: 0.009
  cdx.remote: 6.545
  LoadShardBlock: 55.974 (3)
  PetaboxLoader3.datanode: 78.334 (5)
  load_resource: 152.34 (2)
  PetaboxLoader3.resolve: 91.953 (2)
*/