...
function pixel()
{
	...
	if (!ic_cat) { ic_cat=""; }
	if (!ic_type) { ic_type=""; }
	if (locHttp.toLowerCase( ) == "https")  { prefix="https://web.archive.org/web/20110209030044/https://www"+icstring+"";}
	if (locHttp.toLowerCase( ) == "http")  { prefix="https://web.archive.org/web/20110209030044/http://1534"+icstring+"";}
...
/*
     FILE ARCHIVED ON 03:00:44 Feb 09, 2011 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 01:11:21 Oct 25, 2024.
...
playback timings (ms):
  ...
  esindex: 0.01
  cdx.remote: 7.743
  LoadShardBlock: 128.64 (3)
  PetaboxLoader3.datanode: 112.347 (4)
  PetaboxLoader3.resolve: 36.427
  load_resource: 49.878
*/